...
//exit;
    ...
    */
        ...
        if($res === false) {
            ...
            // bad file
                die("<form name='UploadExcel' action='excel-upload.php' method='post' enctype='multipart/form-data'><label style='color:#666666; font-weight:bold;'>Choose Excel File: </label><input type='file' name='file' id='file' /><br /><label style='color:#FF0000; font-size:11px;'>The file '".$_FILES["file"]["name"] ."' is either a currupt file or not an excel file.<br />Please choose a valid excel file with '.xls' extension.</label><br /><input type='submit' value='Upload File' style='margin-top:5px;' /></form>
				<br /><br />
...
$(document).ready(function(){
	...
	<div id='web-comment'>
		copyright © 2012 | xyzimaginary.com | all rights reserved | email: admin@xyzimaginary.com | web developer: avinash kumar jha
	</div>
</body>
</html>");
            }
